...
public class ChatGPTClient {
    ...
    public boolean validateAPIKey() {
        ...
        HttpRequest request = HttpRequest.newBuilder()
                ...
                .POST(HttpRequest.BodyPublishers.ofString("{\"model\": \"gpt-3.5-turbo\",\"messages\": [{\"role\": \"user\", \"content\":\"Validate API Key\"}]}"))
                .build();
        try {
    ...
    public String queryChatGPT() {
        ...
        try {
            ...
            /*System.out.println("Raw response from ChatGPT: " + responseBody);*/
            ...
            if (jsonResponse.has("choices")) {
                ...
                return "Invalid response from ChatGPT: 'choices' not found.";
            }
        } catch (Exception e) {
            e.printStackTrace();
            return "Failed to connect to ChatGPT.";
        }
    }
